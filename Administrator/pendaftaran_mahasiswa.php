...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../assets/css/style_pendaftaran.css">
...
<body>
        ...
        <div class="menu-bar">
            <div class="menu">
                ...
                <ul class="menu-links">
                    ...
                    <li class="nav-link">
                        <a href="daftar_booking_mahasiswa.php">
                    ...
                    <li class="nav-link">
                        <a href="pendaftaran_mahasiswa.php" class="active">
            ...
            <table>
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            <div class="buttons">
                                <button class="btn" id="success">Tambah</button>
                                <Button class="btn" id="info">Edit</Button>
                                <Button class="btn" id="error">Hapus</Button>
                            </div>
                        </td>
                    </tr>
                    <tr>
    ...
    <script src="../assets/js/notification_daftar.js"></script>
